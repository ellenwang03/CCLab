...
function preload() {
  brokenMirrorImg = loadImage("mirror.png");
  mirrorSound = loadSound("mirror-breaking.mp3");
  bury = loadSound("bury.mp3");
  water = loadSound("water.mp3");
  burn = loadSound("burn.mp3");
}
...
function setup() {
  ...
  buryButton.position(
    ...
    height / 2 - buryButton.height / 2 + 200
  );
